...
//         console.log("Logging form fields:", firstName, lastName, email, country,
//             streetAddress, city, region, postalCode)
//     } // email Parent (name, number, email, wechat); Student (name, number, email, wechat); Student grade in fall; Position (dropdown)
...
//         <form className="bg-white shadow-xs ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" onSubmit={(e) => handleRegister(e)}>
...
//           <p className="mt-1 text-sm/6 text-gray-600">This is information regarding the student. If a section does not apply to you, please enter 'N/A'.</p>
//         </div>
...
//             <button
//               type="submit"
//               className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" disabled={isPending} 
//             >
