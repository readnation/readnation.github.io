              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                    In the weeks, months and years ahead, we will harness the power of the internet to expand our reading program in order to make it accessible to more children all over the world. We believe that every child should have the opportunity to discover the joy of reading, and we’re eager to do our part to achieve this goal.
                  </p>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl/8 text-gray-600">
                  Read Nation is a student-led, non-profit organization that engages children in reading at a formative age.
                </p>
                <p className="mt-10 max-w-xl text-base/7 text-gray-700">
                  Due to the omnipresence of electronics, today’s children are reading less than ever. Not only does this impede their academic development, but it also deprives them of the many other benefits associated with reading, including pleasure, social connectedness, and a more well-rounded perspective of the surrounding world. It is our passion and our privilege to help children acquire and hone critical literacy skills while also igniting in them a lifelong love of reading.
                </p>
              </div>
